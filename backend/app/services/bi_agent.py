...
class ExecutiveBIAgent:
    ...
    def query_procurement_bi(self, user_question: str) -> Dict[str, Any]:
        ...
        if "expensive" in q_lower or "supplier" in q_lower:
            ...
            answer = "ProcureOS achieved a total of ₹1,17,56,250 in verified procurement savings across 34 RFQ projects this quarter (Average 18.6% savings per purchase order)."
        else:
